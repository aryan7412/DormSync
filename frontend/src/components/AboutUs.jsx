  ...
  return (
    <>
      ...
      <section className="relative py-20 px-6 md:px-20 bg-black text-[#39d5ff] z-10">
        <h2 className="text-3xl md:text-4xl text-white font-bold mb-8 text-center font-[orbitron]">What We Do</h2>
        <div className="grid md:grid-cols-2 gap-8">
            <FeaturedCard title="Real-Time Room Availability" desc="Instantly view available rooms and beds in your dorm or zostel." />
        ...
        {/* Who We Are Section */}
        <section className="relative py-20 px-6 md:px-20 bg-black text-[#39d5ff] z-10">
        <h2 className="text-3xl md:text-4xl text-white font-bold mb-8 text-center font-[Orbitron]">Who I Am</h2>
